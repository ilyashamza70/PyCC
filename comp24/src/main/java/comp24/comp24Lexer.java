...
public class comp24Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "LETRA", "DIGITO", "FOR", "WHILE", "IF", "ELSE", "INT", "DOUBLE", 
			"CHAR", "VOID", "BOOL", "COMA", "PYC", "PA", "PC", "LLA", "LLC", "ASIG", 
			"SUMA", "RESTA", "MULT", "DIV", "MOD", "IGUAL", "NEQ", "GT", "LT", "GTE", 
			"LTE", "AND", "OR", "ID", "NUMERO", "WS", "OTRO"
		};
	}
